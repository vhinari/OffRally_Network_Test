...
public class _4thStageManager : StageManager {

	private const float Enemy_xPos = 10f;
	private const float Enemy_yPos = 6f;
	
	private const float RepeatMin = 2f;
	private const float RepeatMax = 3.5f;
	
	public _4thStageManager() 
	{
		...
		for (int iCount = 0; iCount < _Enemy.Length; iCount++)
		{
			...
			_Enemy[iCount].AddComponent<Enemy_04> ();	
		}
